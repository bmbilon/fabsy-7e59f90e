        ...
        <div className="prose prose-lg max-w-none space-y-8 text-white/90">
          ...
          <section id="fee-refund-guarantee" className="scroll-mt-24 rounded-xl border border-emerald-300/40 bg-white/10 p-6">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>This is not a promise that the Crown will respond or the case will finish within 30 days. Once a qualifying rejection has been received, further negotiation or waiting for your instructions does not postpone the refund deadline.</li>
