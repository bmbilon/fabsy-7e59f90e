...
export default function RapidResolutionAlternate() {
  ...
  return <div className="rapid-landing min-h-screen bg-white text-slate-900">
    ...
    <main id="main-content">
      ...
      <section aria-labelledby="rapid-final-heading" className="bg-slate-950 px-5 py-10 text-center text-white"><h2 id="rapid-final-heading" className="text-2xl font-bold text-white sm:text-3xl">Put your ticket into motion today.</h2><p className="mt-[12px] text-slate-200">{price} (${total} total), paid at checkout.</p><p className="mx-auto mt-[12px] max-w-xl text-sm text-slate-200">Lower fine, fewer demerits, or withdrawal — or your service fee is refunded<Link to={FEE_REFUND.termsPath} className="text-white underline" aria-label="Fee-refund conditions">*</Link></p><RapidResolutionCta position="footer" className="mt-5 w-full sm:w-auto" /></section>
    </main>
