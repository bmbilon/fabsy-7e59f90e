...
export default function HeaderContactLinks() {
  ...
  return (
    <div className="flex flex-col items-center border-t border-slate-100 lg:flex-row lg:justify-end lg:gap-6">
      <div className="grid w-full grid-cols-[auto_minmax(0,1fr)] items-center gap-x-3 sm:flex sm:justify-center sm:gap-x-6 lg:w-auto lg:justify-end">
        <a
