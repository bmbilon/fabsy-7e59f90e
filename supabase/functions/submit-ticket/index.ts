...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (formData.draftAccessToken !== undefined) {
      ...
      const draftAccessTokenHash = await intakeAccessTokenHash(draftAccessToken, ticketCompletionSecret(), typeof formData.draftId === "string" ? formData.draftId : undefined);
