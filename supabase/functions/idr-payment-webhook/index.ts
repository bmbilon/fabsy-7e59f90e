...
async function sendTicketAssessmentConfirmation(
  ...
  try {
    ...
    await sendResendEmail(apiKey, {
      ...
      to: [client.email],
      subject: "Fabsy received your Traffic Ticket + Insurance Impact Assessment",
      html: `<div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;color:#1f2937"><h1>Payment received—your assessment is in the review queue</h1><p>Hi ${escapeHtml(client.first_name)},</p><p>Fabsy received your private ticket upload and assessment information.</p><div style="background:#f5f3ff;border:1px solid #ddd6fe;border-radius:10px;padding:18px;margin:24px 0"><p style="margin:0 0 8px"><strong>Payment:</strong> $149 CAD total, one-time; applicable GST included</p><p style="margin:0 0 8px"><strong>Ticket:</strong> received</p><p style="margin:0"><strong>Next:</strong> a Fabsy team member will complete a human review and email your Traffic Ticket + Insurance Impact Assessment.</p></div><div style="background:#f5f3ff;border:1px solid #c4b5fd;border-radius:10px;padding:18px;margin:24px 0"><p style="margin:0 0 8px"><strong>If representation is worthwhile:</strong> the $149 assessment payment can be applied to Fabsy's $488 base representation fee for the same eligible matter, leaving a $339 base-fee balance plus applicable tax.</p><p style="margin:0">Eligible assessment clients also receive priority placement. The 30% success fee still applies to any fine reduction.</p></div><p>Fabsy will review the charge and deadline, fine and demerit implications, available options, likely insurance-risk significance, representation economics and the recommended next step.</p><p>If a response deadline is close, reply to this email or call (825) 793-2279 after submitting. The assessment does not pause any deadline printed on the ticket.</p><p style="font-size:13px;color:#6b7280;line-height:1.5">Insurance treatment varies by insurer, driving history, jurisdiction, renewal timing and other underwriting factors. This assessment is not a binding insurance quote or guarantee of premium changes. Fabsy is an Alberta traffic ticket agent service, not a law firm, and no outcome is promised.</p>${getFabsyEmailSignature()}</div>`,
