...
//#endregion
//#region src/index.ts
// Local deployment asset; consent generation never fetches WASM over the network.
init(await createHarfBuzz({ wasmBinary: await Deno.readFile(new URL("./harfbuzz.wasm", import.meta.url)) }));
//#endregion
