...
def run() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="fabsy-verification-pg-", dir="/tmp") as folder:
        ...
        command([
            ...
            "-U", "fabsy_verification_test", "--no-locale", "--encoding=UTF8",
        ])
        started = False
        try:
            command([
            ...
            connection = [
                ...
                "-U", "fabsy_verification_test", "-d", "postgres", "-v", "ON_ERROR_STOP=1",
            ]
